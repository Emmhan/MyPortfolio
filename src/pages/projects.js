  ...
  return `
    <section class="section-shell projects page-section featured-projects">
      ...
      <div class="featured-grid">
        ...
        <a class="featured-card project-placeholder-card" data-category="mobile" href="/projects/mobile-project"><h2>Mobile Application Project</h2><span class="project-type mobile-type">▣ &nbsp; Mobile</span><div class="project-image mobile-project-image"></div></a>
      </div>
